...
public class SGBTest7 {
	...
	sgb.addHalfRectangles(20.0, 20.0, 2,
			      SteppedGrid.Builder.Corner.LOWER_LEFT, 0.0, 0.0);
	sgb.addHalfRectangles(70.0, 20.0, 2,
			      SteppedGrid.Builder.Corner.LOWER_RIGHT, 0.0, 0.0);
	sgb.addHalfRectangles(70.0, 70.0, 2,
			      SteppedGrid.Builder.Corner.UPPER_RIGHT, 0.0, 0.0);
