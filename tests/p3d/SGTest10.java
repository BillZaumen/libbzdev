...
public class SGTest10 {
	...
	sg.addHalfComponent(0, 0, 1.0, -1.0, true, true);
	sg.addHalfComponent(2, 0, 1.0, -1.0, true, true);
	sg.addHalfComponent(0, 2, 1.0, -1.0, true, true);
	sg.addHalfComponent(2, 2, 1.0, -1.0, true, true);
