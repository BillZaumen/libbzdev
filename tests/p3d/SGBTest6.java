...
public class SGBTest6 {
	...
	sgb.addHalfRectangles(0.0, 0.0, 1,
			      SteppedGrid.Builder.Corner.UPPER_RIGHT,
			      0.0, 0.0);
	sgb.addHalfRectangles(90.0, 0.0, 1, 
			      SteppedGrid.Builder.Corner.UPPER_LEFT,
			      0.0, 0.0);
	sgb.addHalfRectangles(90.0, 90.0, 1,
			      SteppedGrid.Builder.Corner.LOWER_LEFT,
			      0.0, 0.0);
	sgb.addHalfRectangles(0.0, 90.0, 1,
			      SteppedGrid.Builder.Corner.LOWER_RIGHT,
			      0.0, 0.0);

	sgb.addHalfRectangles(20.0, 20.0, 1,
			      SteppedGrid.Builder.Corner.LOWER_LEFT,
			      0.0, 0.0);
	sgb.addHalfRectangles(70.0, 20.0, 1,
			      SteppedGrid.Builder.Corner.LOWER_RIGHT,
			      0.0, 0.0);
	sgb.addHalfRectangles(70.0, 70.0, 1,
			      SteppedGrid.Builder.Corner.UPPER_RIGHT,
			      0.0, 0.0);
	sgb.addHalfRectangles(20.0, 70.0, 1,
			      SteppedGrid.Builder.Corner.UPPER_LEFT,
			      0.0, 0.0);
	sgb.create(m3d);
