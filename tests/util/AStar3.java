...
public class AStar3 {
	...
	OutputStream os = new FileOutputStream("astar3.svg");
	OutputStreamGraphics osg = OutputStreamGraphics
	    .newInstance(os, 1024, 1024, "svg");
	...
	AStarSearch<Node> search1 = new AStarSearch<>(AStar3::getNeighbors,
						      AStar3::dist,
						      null);

	AStarSearch<Node> search2 = new AStarSearch<>(AStar3::getNeighbors,
						      AStar3::dist,
						      AStar3::dist);
