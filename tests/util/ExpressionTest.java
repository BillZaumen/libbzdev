...
public class ExpressionTest {
	...
	*/
	...
	Pair[] pairs = {
	    ...
	    new Pair("= -1.0 %% 5", 4),
	    new Pair("= 6.0 %% 5", 1),
	    new Pair("= (3 + 5000000000000) %% 5", 3),
	    new Pair("= (-1 - 5000000000000) %% 5", 4),
	    new Pair("= (6 + 50000000000000) %% 5", 1),
	    ...
	    // check invariant: (n /% m)*m = (n % m) = n
	    // where n is a number and m is a non-zero integer.
	    new Pair("= (23 /% 10)*10 + 23 % 10", 23),
	    new Pair("= (-23 /% 10)*10 + -23 % 10", -23),
	    new Pair("= (23 /% -10)*(-10) + 23 % -10", 23),
	    new Pair("= (-23 /% -10)*(-10) + -23 % -10", -23),
	    new Pair("= (23.3 /% 10)*10 + 23.3 % 10", 23.3),
	    new Pair("= (-23.3 /% 10)*10 + -23.3 % 10", -23.3),
	    new Pair("= (23.3 /% -10)*(-10) + 23.3 % -10", 23.3),
	    new Pair("= (-23.3 /% -10)*(-10) + -23.3 % -10", -23.3),
