...
class RectObject2 extends DirectedObject2D {
    Path2D shape;
    RectObject2(Animation2D animation, String name, boolean intern) {
...
public class RelativeTest2 {
	...
	try {
	    ...
	    final RectObject2 obj = new RectObject2(animation, "obj", true);
	    ...
	    animation.initFrames(maxFrames, "rtmp2/col-", "png");
	    animation.scheduleFrames(0, maxFrames);
	    File dir = new File("rtmp2");
	    dir.mkdirs();
	    ...
	    */
	    final RealValuedFunctOps angleF = (tau) -> {return 0.0;};
