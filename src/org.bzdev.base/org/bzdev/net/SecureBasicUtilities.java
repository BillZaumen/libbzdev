...
public class SecureBasicUtilities {
    ...
    /**
     * Get a Unicode realm string from a textual one
     * Realms that start with the strings "[D]" (for digest),
     * "[S]" for the use of a signature without a certificate,
     * and "[SC]" for the use of a signature with certificates
     * are treated specially.  Realms provided by a user should
     * not start with these strings.
     * @param realm the realm in textual form
     * @return a Unicode string using emojis as icons.
     */
     ...
     */
    public char[] createPassword(Certificate[] certs,
				 char[] password)
