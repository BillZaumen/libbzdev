 ...
 * integers passed to its {@link ShortComparator#compare(short,short)}
 * using primitive types (<code>short</code> instead of <code>Short</code>).
 ...
 * <code>Comparator&lt;short&gt;</code> will generate a compile-time error,
 * although <code>Comparator&lt;Short&gt;</code> can be used in some cases
 * due to autoboxing.
...
public interface ShortComparator {
   /**
     ...
     *
     * @param o1 the first short-integer to be compared.
     * @param o2 the second short-integer to be compared.
...
//  LocalWords:  ShortComparator autoboxing tt sgn signum implementor
//  LocalWords:  hashCode
