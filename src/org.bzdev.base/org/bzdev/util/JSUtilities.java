...
public class JSUtilities {
     ...
     * {@link JSUtilities.YAML.Parser} to handle multiple independent
     * objects
     * <P>
     ...
     * {@link JSUtilities.YAML.TagSpec}, and using that in a suitable
     ...
     * @see JSUtilities.YAML.TagSpec
     * @see JSUtilities.YAML.Parser#Parser(Reader,TagSpec...)
     */
	...
	public static class TagSpec {
	     ...
	     * exclamation points: for example if the prefix is
	...
	public static class Parser extends JSON.Parser  {
	    ...
	    */
	    ...
	    /**
	     * Get the object generated by a parser.
	     * If the parser was created with a tag specification,
	     * additional types may be returned.
	     * @return the object (a Boolean, Integer, Long, Double,
	     *         JSArray, JSObject, or the value null)
	     * @throws IOException if an IO error occurred
	     * @see Parser#Parser(Reader, TagSpec...)
	     */
	    @Override
	    public Object getResults() throws IOException {
		switch (termination) {
