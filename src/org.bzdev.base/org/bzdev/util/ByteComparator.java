 ...
 * integers passed to its {@link ByteComparator#compare(byte,byte)}
 * using primitive types (<code>byte</code> instead of <code>Byte</code>).
 ...
 * <code>Comparator<byte></code> will generate a compile-time error,
 * although <code>Comparator<Byte></code> can be used in some cases
 * due to autoboxing.
...
//  LocalWords:  ByteComparator autoboxing tt sgn signum implementor
//  LocalWords:  hashCode
