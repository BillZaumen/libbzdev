 ...
 * integers passed to its {@link IntComparator#compare(int,int)}
 * using primitive types (<code>int</code> instead of <code>Integer</code>).
 ...
 * where one has to search an array of indices with the comparison made
 * on objects in the array to which the indices apply.
...
//  LocalWords:  IntComparator autoboxing SuffixArray indices tt sgn
//  LocalWords:  signum implementor hashCode
