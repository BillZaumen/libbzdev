 ...
 * integers passed to its {@link DoubleComparator#compare(double,double)}
 * using primitive types (<code>double</code> instead of <code>Double</code>).
 ...
 * <code>Comparator<double></code> will generate a compile-time error,
 * although <code>Comparator<Double></code> can be used in some cases
 * due to autoboxing.
...
public interface DoubleComparator {
   /**
     ...
     *
     * @param o1 the first double to be compared.
     * @param o2 the second double to be compared.
...
//  LocalWords:  DoubleComparator autoboxing tt sgn signum implementor
//  LocalWords:  hashCode
