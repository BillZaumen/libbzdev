 ...
 * integers passed to its {@link LongComparator#compare(long,long)}
 * using primitive types (<code>long</code> instead of <code>Long</code>).
...
public interface LongComparator {
   /**
     ...
     *
     * @param o1 the first long-integer to be compared.
     * @param o2 the second long-integer to be compared.
...
//  LocalWords:  LongComparator autoboxing tt sgn signum implementor
//  LocalWords:  hashCode
