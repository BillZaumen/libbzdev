 ...
 * integers passed to its {@link CharComparator#compare(char,char)}
 * using primitive types (<code>char</code> instead of <code>Char</code>).
 ...
 * <code>Comparator<char></code> will generate a compile-time error,
 * although <code>Comparator<Char></code> can be used in some cases
 * due to autoboxing.
...
public interface CharComparator {
   /**
     ...
     *
     * @param o1 the first char to be compared.
     * @param o2 the second char to be compared.
...
//  LocalWords:  CharComparator autoboxing tt sgn signum implementor
//  LocalWords:  hashCode
