 ...
 * </blockquote>
 * The sequence of double-precision numbers generated by instances of
 * this class are values of k with the distribution given above, provided
 * the values are not so large that successive integers cannot be
 * distinguished.
 * <P>
...
public class PoissonDoubleRV extends DoubleRandomVariable {
	...
	(int)(Math.round((double)Double.MAX_VALUE
			 - 10.0 * Math.sqrt((double)Double.MAX_VALUE)));
     ...
     */
    public Double next() {
	return StaticRandom.poissonDouble(lambda, mode);
    }
}
