 ...
 * </blockquote>
 * The sequence of long integers generated by instances of this class
...
public class PoissonLongRV extends LongRandomVariable {
	...
	(int)(Math.round((double)Long.MAX_VALUE
			 - 10.0 * Math.sqrt((double)Long.MAX_VALUE)));
     ...
     */
    public PoissonLongRV(double lambda) {
	this(lambda, false);
    }
    /**
     ...
     */
    public PoissonLongRV(double lambda, boolean mode) {
	if (lambda < 0.0) throw new IllegalArgumentException
			      (errorMsg("lambdaNotNegative", lambda));
	if (lambda > MAX_LAMBDA) {
	    String msg = errorMsg("lambdaTooLarge", lambda);
     ...
     */
    public Long next() {
	return StaticRandom.poissonLong(lambda, mode);
    }
}
