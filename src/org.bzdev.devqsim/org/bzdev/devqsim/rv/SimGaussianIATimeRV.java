 ...
 * sequence of interarrival times with a Gaussian distribution.
 * The values are rounded to the nearest long integer.
 * @see org.bzdev.math.rv.GaussianIATimeRV
 */
public class SimGaussianIATimeRV extends SimInterarrivalTimeRV<GaussianIATimeRV>
{
    /**
     * Constructor.
     ...
     */
    protected SimGaussianIATimeRV(Simulation sim, String name, boolean intern) {
     ...
     * @see org.bzdev.devqsim.Simulation#getObject(String,Class)
     */
    public SimGaussianIATimeRV(Simulation sim, String name, boolean intern,
			 GaussianIATimeRV rv)
    {
