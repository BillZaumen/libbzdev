 ...
 * sequence of integers with a uniform distribution.
...
public class SimUniformIntegerRV extends SimIntegerRV<UniformIntegerRV>
{
     ...
     */
    protected SimUniformIntegerRV(Simulation sim, String name, boolean intern) {
     ...
     * @see org.bzdev.devqsim.Simulation#getObject(String,Class)
     */
    public SimUniformIntegerRV(Simulation sim, String name, boolean intern,
			 UniformIntegerRV rv)
    {
