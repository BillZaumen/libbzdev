 ...
 * sequence of integers with a deterministic distribution.
 * @see org.bzdev.math.rv.DetermIntegerRV
 */
public class SimDetermIntegerRV extends SimIntegerRV<DetermIntegerRV>
{
    /**
     * Constructor.
     ...
     */
    protected SimDetermIntegerRV(Simulation sim, String name, boolean intern) {
     ...
     * @see org.bzdev.devqsim.Simulation#getObject(String,Class)
     */
    public SimDetermIntegerRV(Simulation sim, String name, boolean intern,
			 DetermIntegerRV rv)
    {
