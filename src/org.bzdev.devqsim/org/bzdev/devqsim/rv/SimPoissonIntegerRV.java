 ...
 * sequence of integers with a Poisson distribution.
 * @see org.bzdev.math.rv.PoissonIntegerRV
 */
public class SimPoissonIntegerRV extends SimIntegerRV<PoissonIntegerRV>
{
    /**
     * Constructor.
     ...
     */
    protected SimPoissonIntegerRV(Simulation sim, String name, boolean intern) {
     ...
     * @see org.bzdev.devqsim.Simulation#getObject(String,Class)
     */
    public SimPoissonIntegerRV(Simulation sim, String name, boolean intern,
			 PoissonIntegerRV rv)
    {
