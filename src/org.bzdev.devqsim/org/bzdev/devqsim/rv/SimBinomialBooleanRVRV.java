    ...
    extends SimBooleanRVRV<BinomialBooleanRV,BinomialBooleanRVRV>
{
     ...
     */
    protected SimBinomialBooleanRVRV(Simulation sim, String name,
				   boolean intern)
    {
     ...
     * @see org.bzdev.devqsim.Simulation#getObject(String,Class)
     */
    public SimBinomialBooleanRVRV(Simulation sim, String name, boolean intern,
				  BinomialBooleanRVRV rv)
    {
	super(sim, name, intern);
	super.setRV(rv);
    }
