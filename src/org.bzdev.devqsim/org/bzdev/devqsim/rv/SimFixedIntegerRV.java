 ...
 * sequence of integers with an fixed distribution.
 * @see org.bzdev.math.rv.FixedIntegerRV
 */
public class SimFixedIntegerRV extends SimIntegerRV<FixedIntegerRV>
{
    /**
     * Constructor.
     ...
     */
    protected SimFixedIntegerRV(Simulation sim, String name, boolean intern) {
     ...
     * @see org.bzdev.devqsim.Simulation#getObject(String,Class)
     */
    public SimFixedIntegerRV(Simulation sim, String name, boolean intern,
			 FixedIntegerRV rv)
    {
