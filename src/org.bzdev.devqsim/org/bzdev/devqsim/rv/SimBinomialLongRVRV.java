 ...
 * sequence of long-integer valued random variables with a binomial
 * distribution.
 * @see org.bzdev.math.rv.BinomialLongRV;
 */
public class SimBinomialLongRVRV
    extends SimLongRVRV<BinomialLongRV,BinomialLongRVRV>
{
    /**
     * Constructor.
     ...
     */
    protected SimBinomialLongRVRV(Simulation sim, String name,
				   boolean intern)
    {
     ...
     * @see org.bzdev.devqsim.Simulation#getObject(String,Class)
     */
    public SimBinomialLongRVRV(Simulation sim, String name, boolean intern,
				  BinomialLongRVRV rv)
    {
	super(sim, name, intern);
	super.setRV(rv);
