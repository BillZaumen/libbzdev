 ...
 * sequence of double-precision numbers with a log normal distribution.
 * org.bzdev.math.rv.LogNormalRV
 */
public class SimLogNormalRV extends SimDoubleRV<LogNormalRV>
{
    /**
     * Constructor.
     ...
     */
    protected SimLogNormalRV(Simulation sim, String name, boolean intern) {
     ...
     * @see org.bzdev.devqsim.Simulation#getObject(String,Class)
     */
    public SimLogNormalRV(Simulation sim, String name, boolean intern,
			 LogNormalRV rv)
    {
