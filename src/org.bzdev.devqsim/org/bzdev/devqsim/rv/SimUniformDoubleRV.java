 ...
 * sequence of double-precision numbers with a uniform distribution.
...
public class SimUniformDoubleRV extends SimDoubleRV<UniformDoubleRV>
{
     ...
     */
    protected SimUniformDoubleRV(Simulation sim, String name, boolean intern) {
     ...
     * @see org.bzdev.devqsim.Simulation#getObject(String,Class)
     */
    public SimUniformDoubleRV(Simulation sim, String name, boolean intern,
			 UniformDoubleRV rv)
    {
