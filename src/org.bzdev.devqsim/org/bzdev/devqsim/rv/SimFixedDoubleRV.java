 ...
 * sequence of double-precision numbers with an fixed distribution.
...
public class SimFixedDoubleRV extends SimDoubleRV<FixedDoubleRV>
{
     ...
     */
    protected SimFixedDoubleRV(Simulation sim, String name, boolean intern) {
     ...
     * @see org.bzdev.devqsim.Simulation#getObject(String,Class)
     */
    public SimFixedDoubleRV(Simulation sim, String name, boolean intern,
			 FixedDoubleRV rv)
    {
