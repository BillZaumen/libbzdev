 ...
 * sequence of double-precision numbers with a deterministic distribution.
 * @see org.bzdev.math.rv.DetermDoubleRV
 */
public class SimDetermDoubleRV extends SimDoubleRV<DetermDoubleRV>
{
    /**
     * Constructor.
     ...
     */
    protected SimDetermDoubleRV(Simulation sim, String name, boolean intern) {
     ...
     * @see org.bzdev.devqsim.Simulation#getObject(String,Class)
     */
    public SimDetermDoubleRV(Simulation sim, String name, boolean intern,
			 DetermDoubleRV rv)
    {
