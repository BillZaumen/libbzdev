 ...
 * sequence of long integers representing interarrival times with a
 * binomial distribution.
 * @see org.bzdev.math.rv.BinomialIATimeRV
 */
public class SimBinomialIATimeRV extends SimInterarrivalTimeRV<BinomialIATimeRV>
{
    /**
     * Constructor.
     ...
     */
    protected SimBinomialIATimeRV(Simulation sim, String name, boolean intern) {
     ...
     * @see org.bzdev.devqsim.Simulation#getObject(String,Class)
     */
    public SimBinomialIATimeRV(Simulation sim, String name, boolean intern,
			 BinomialIATimeRV rv)
    {
