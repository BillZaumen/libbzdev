 ...
 * sequence of integers with a binomial distribution.
...
public class SimBinomialIntegerRV extends SimIntegerRV<BinomialIntegerRV>
{
     ...
     */
    protected SimBinomialIntegerRV(Simulation sim, String name, boolean intern) {
     ...
     * @see org.bzdev.devqsim.Simulation#getObject(String,Class)
     */
    public SimBinomialIntegerRV(Simulation sim, String name, boolean intern,
			 BinomialIntegerRV rv)
    {
