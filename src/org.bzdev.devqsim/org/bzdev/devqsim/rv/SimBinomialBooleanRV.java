 ...
 * sequence of boolean value with a binomial distribution.
...
public class SimBinomialBooleanRV extends SimBooleanRV<BinomialBooleanRV>
{
     ...
     */
    protected SimBinomialBooleanRV(Simulation sim, String name,
				   boolean intern)
    {
     ...
     * @see org.bzdev.devqsim.Simulation#getObject(String,Class)
     */
    public SimBinomialBooleanRV(Simulation sim, String name, boolean intern,
			 BinomialBooleanRV rv)
    {
