 ...
 * sequence of double-precision numbers with an exponential distribution.
 * @see org.bzdev.math.rv.ExpDistrRV
 */
public class SimExpDistrRV extends SimDoubleRV<ExpDistrRV>
{
     ...
     */
    protected SimExpDistrRV(Simulation sim, String name, boolean intern) {
     ...
     * @see org.bzdev.devqsim.Simulation#getObject(String,Class)
     */
    public SimExpDistrRV(Simulation sim, String name, boolean intern,
			 ExpDistrRV rv)
    {
