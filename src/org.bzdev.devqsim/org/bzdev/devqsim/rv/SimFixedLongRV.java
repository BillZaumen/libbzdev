 ...
 * sequence of long integers with an fixed distribution.
...
public class SimFixedLongRV extends SimLongRV<FixedLongRV>
{
     ...
     */
    protected SimFixedLongRV(Simulation sim, String name, boolean intern) {
     ...
     * @see org.bzdev.devqsim.Simulation#getObject(String,Class)
     */
    public SimFixedLongRV(Simulation sim, String name, boolean intern,
			 FixedLongRV rv)
    {
