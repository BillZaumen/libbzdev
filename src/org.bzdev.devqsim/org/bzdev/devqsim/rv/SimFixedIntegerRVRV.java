 ...
 * sequence of integer-valued random variables with a fixed distribution.
 * @see org.bzdev.math.rv.FixedIntegerRV;
 */
public class SimFixedIntegerRVRV
    extends SimIntegerRVRV<FixedIntegerRV,FixedIntegerRVRV>
{
    /**
     * Constructor.
     ...
     */
    protected SimFixedIntegerRVRV(Simulation sim, String name,
				   boolean intern)
    {
     ...
     * @see org.bzdev.devqsim.Simulation#getObject(String,Class)
     */
    public SimFixedIntegerRVRV(Simulation sim, String name, boolean intern,
				  FixedIntegerRVRV rv)
    {
	super(sim, name, intern);
	super.setRV(rv);
