 ...
 * sequence of interarrival times with a fixed distribution.
...
public class SimFixedIATimeRV extends SimInterarrivalTimeRV<FixedIATimeRV>
{
     ...
     */
    protected SimFixedIATimeRV(Simulation sim, String name, boolean intern) {
     ...
     * @see org.bzdev.devqsim.Simulation#getObject(String,Class)
     */
    public SimFixedIATimeRV(Simulation sim, String name, boolean intern,
			 FixedIATimeRV rv)
    {
