 ...
 * sequence of long-integer-valued random variables, each with a
 * binomial distribution.
 * @see org.bzdev.math.rv.PoissonLongRV
 */
public class SimPoissonLongRVRV
    extends SimLongRVRV<PoissonLongRV,PoissonLongRVRV>
{
    /**
     * Constructor.
     ...
     */
    protected SimPoissonLongRVRV(Simulation sim, String name,
				   boolean intern)
    {
     ...
     * @see org.bzdev.devqsim.Simulation#getObject(String,Class)
     */
    public SimPoissonLongRVRV(Simulation sim, String name, boolean intern,
				  PoissonLongRVRV rv)
    {
	super(sim, name, intern);
	super.setRV(rv);
