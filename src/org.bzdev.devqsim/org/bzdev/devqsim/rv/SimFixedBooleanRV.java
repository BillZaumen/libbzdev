 ...
 * sequence of boolean value with a fixed distribution.
...
public class SimFixedBooleanRV extends SimBooleanRV<FixedBooleanRV>
{
     ...
     */
    protected SimFixedBooleanRV(Simulation sim, String name,
				   boolean intern)
    {
     ...
     * @see org.bzdev.devqsim.Simulation#getObject(String,Class)
     */
    public SimFixedBooleanRV(Simulation sim, String name, boolean intern,
			 FixedBooleanRV rv)
    {
