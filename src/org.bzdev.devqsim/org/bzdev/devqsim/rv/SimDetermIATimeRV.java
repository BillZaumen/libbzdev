 ...
 * @see org.bzdev.math.rv.DetermIATimeRV
 */
public class SimDetermIATimeRV extends SimInterarrivalTimeRV<DetermIATimeRV>
{
    /**
     * Constructor.
     ...
     */
    protected SimDetermIATimeRV(Simulation sim, String name, boolean intern) {
     ...
     * @see org.bzdev.devqsim.Simulation#getObject(String,Class)
     */
    public SimDetermIATimeRV(Simulation sim, String name, boolean intern,
			 DetermIATimeRV rv)
    {
