 ...
 * sequence of long integers with a deterministic distribution.
 * @see org.bzdev.math.rv.DetermLongRV
 */
public class SimDetermLongRV extends SimLongRV<DetermLongRV>
{
     ...
     */
    protected SimDetermLongRV(Simulation sim, String name, boolean intern) {
     ...
     * @see org.bzdev.devqsim.Simulation#getObject(String,Class)
     */
    public SimDetermLongRV(Simulation sim, String name, boolean intern,
			 DetermLongRV rv)
    {
