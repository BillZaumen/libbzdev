...
/**
 * Menu Item that displays a dialog box containing a {@link VTextField}
...
public class VTextFieldMenuItem extends JMenuItem {
     ...
     * @param modal true for a modal dialog; false otherwise
     */
    public VTextFieldMenuItem(VTextField tf, String label,
    ...
    /**
     * Free resources associated with this menu item.
     * After this method is called, the menu item must not be used.
     */
    public void dispose() {
	dialog.dispose();
    }
