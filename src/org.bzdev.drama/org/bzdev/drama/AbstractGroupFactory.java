 ...
 * of org.bzdev.drama.Group. Generally, there will be a class hierarchy
 * of abstract factories matching the class hierarchy for subclasses of
 * Group, each responsible for providing parameters for the corresponding
 * Group subclass, plus a factory that is not abstract for each class
 * that can be created.
 * <P>
 ...
 * </ul>
 */
abstract public class AbstractGroupFactory<Obj extends Group>
    extends GenericGroupFactory<AbstractGroupFactory<Obj>, DramaSimulation,
	    Actor,Condition,Domain,DomainMember,
	    DramaFactory,Group,Obj>
{
     ...
     */
    protected AbstractGroupFactory(DramaSimulation sim) {
	super(sim);
    }
}

//  LocalWords:  subclasses ul li superclasses traceSetMode traceSets
