...
/**
 * Abstract class for GenericMsgFrwdngInfo factories.  This class is
 * provided so that factories that create subclasses of
 * GenericMsgForwdngInfo can be coded in the same way as factories for
 * other drama.generic objects by providing an analogous set of
 * parameterized types as other factories in this package.
 *  <P>
 * There are no factory parameters directly associated with this class.
 ...
 */
abstract public class GenericMsgFrwdngInfoFactory<
    OF extends GenericMsgFrwdngInfoFactory<OF,S,A,C,D,DM,F,G,Obj>,
    ...
    Obj extends GenericMsgFrwdngInfo<S,A,C,D,DM,F,G>>
...
//  LocalWords:  GenericMsgFrwdngInfo subclasses superclasses ul li
//  LocalWords:  GenericMsgForwdngInfo traceSetMode traceSets
