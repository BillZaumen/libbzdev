 ...
 * The parameters this factory inherits from its superclasses are the following:
 * <ul>
...
abstract public class AbstractConditionFactory<Obj extends Condition>
    extends GenericCondFactory<AbstractConditionFactory<Obj>,
	    ...
	    DramaFactory,Group,Obj>
{
     ...
     */
    protected AbstractConditionFactory(DramaSimulation sim) {
	super(sim);
    }
}

//  LocalWords:  subclasses superclasses ul li traceSetMode traceSets
